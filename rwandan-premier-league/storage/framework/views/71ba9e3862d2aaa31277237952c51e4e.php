        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="glass-card">
                <div class="flex justify-between items-center">
                    <h2 class="text-2xl text-white font-bold"><?php echo e($post->title); ?></h2>
                    <span class="text-sm text-yellow-400"><?php echo e($post->category); ?></span>
                </div>
                <p class="text-white mt-4"><?php echo e($post->content); ?></p>

                <?php if($post->image): ?>
                <img src="<?php echo e(asset('storage/' . $post->image)); ?>" alt="Post Image" class="rounded-lg mt-4">
                <?php endif; ?>
                ...
                <div class="mt-4 flex justify-between items-center">
                    ...
                    <a href="/posts/<?php echo e($post->id); ?>/edit" class="btn-primary">
                        Edit ✍️
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\rwandan-premier-league\resources\views/team/posts/index.blade.php ENDPATH**/ ?>