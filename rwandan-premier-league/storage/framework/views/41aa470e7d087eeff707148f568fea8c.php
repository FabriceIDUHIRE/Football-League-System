    ...
    <div class="card">
        <div class="row g-0">
            ...
            <div class="col-md-4 d-flex align-items-center justify-content-center p-3">
                <?php if($player->image): ?>
                <img src="<?php echo e(asset('storage/' . $player->image)); ?>" alt="<?php echo e($player->name); ?>" class="img-fluid rounded" style="width: 100%; margin-top:3rem; border-radius:100%;">
                <?php else: ?>
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('team.player-management')); ?>" class="btn btn-secondary mt-3">Back to Players List</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.team_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rwandan-premier-league\resources\views/team/playerDetails.blade.php ENDPATH**/ ?>