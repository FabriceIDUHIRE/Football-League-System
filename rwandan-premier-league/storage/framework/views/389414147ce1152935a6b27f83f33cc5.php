    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Edit button -->
                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#staffModal" onclick="openModal(<?php echo e($member); ?>)">Edit</button>

                    <!-- Delete button -->
                    <form action="<?php echo e(route('staff.destroy', $member->id)); ?>" method="POST" style="display:inline;">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="staffForm" action="<?php echo e(route('staff.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.team_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rwandan-premier-league\resources\views/team/partials/staff.blade.php ENDPATH**/ ?>