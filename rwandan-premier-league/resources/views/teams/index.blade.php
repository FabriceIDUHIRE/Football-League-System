...
<div class="row justify-content-center g-4" style="margin-top: 7rem;">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center">
        <div class="card text-center shadow-lg border-0" 
             ...
             onclick="window.location='{{ route('teams.show', $team->id) }}';"
            ...
            <img src="{{ asset('storage/' . $team->logo) }}" alt="Team Logo"  class="img-fluid mb-3"   style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%; border: 3px solidrgb(172, 181, 188);">
                <h5 class="card-title" style="font-size: 1.4rem; font-weight: bold; color: #343a40;">{{ $team->name }}</h5>
            </div>
        </div>
    </div>
    @endforeach
