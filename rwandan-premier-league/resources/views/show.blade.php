...
@endforeach
        ...
        <div class="form-group">
            ...
            <input type="number" name="home_team_score" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="goals_home_team">Goals</label>
            <input type="number" name="goals_home_team" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="yellow_cards_home_team">Yellow Cards</label>
        ...
        <div class="form-group">
            ...
            <input type="number" name="away_team_score" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="goals_away_team">Goals</label>
            <input type="number" name="goals_away_team" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="yellow_cards_away_team">Yellow Cards</label>
...
<div class="form-group">
    ...
    <select name="referee_id" id="referee_id" class="form-control" required>
        ...
        <div class="form-group">
            ...
            <select name="assistant_referee_1_id" id="assistant_referee_1_id" class="form-control">
                @foreach($referees as $referee)
                    <option value="{{ $referee->id }}">{{ $referee->name }}</option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <select name="assistant_referee_2_id" id="assistant_referee_2_id" class="form-control">
                @foreach($referees as $referee)
                    <option value="{{ $referee->id }}">{{ $referee->name }}</option>
                @endforeach
            </select>
