...
@foreach($tickets as $ticket)
    <tr>
        <td>{{ $ticket->id }}</td>
        <td>{{ $ticket->event }}</td>
            <td>{{ $ticket->homeTeam ? $ticket->homeTeam->name : 'No Home Team' }}</td>
            <td>{{ $ticket->awayTeam ? $ticket->awayTeam->name : 'No Away Team' }}</td>
            <td>${{ $ticket->price }}</td>
            <td>{{ $ticket->seats }}</td>
            <td>{{ $ticket->status }}</td>
        <td>
            <a href="{{ route('tickets.edit', $ticket->id) }}" class="btn btn-warning btn-sm btn-custom">Edit</a>
