    ...
    <div class="card">
        <div class="row g-0">
            ...
            <div class="col-md-4 d-flex align-items-center justify-content-center p-3">
                @if($player->image)
                <img src="{{ asset('storage/' . $player->image) }}" alt="{{ $player->name }}" class="img-fluid rounded" style="width: 100%; margin-top:3rem; border-radius:100%;">
                @else
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <a href="{{ route('team.player-management') }}" class="btn btn-secondary mt-3">Back to Players List</a>
                </div>
            </div>
        </div>
    </div>
